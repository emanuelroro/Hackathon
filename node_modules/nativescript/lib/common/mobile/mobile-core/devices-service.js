...
class DevicesService extends events_1.EventEmitter {
    constructor($logger, $errors, $iOSSimulatorDiscovery, $iOSDeviceDiscovery, $androidDeviceDiscovery, $staticConfig, $messages, $mobileHelper, $deviceLogProvider, $hostInfo, $injector, $options, $androidProcessService, $processService, $iOSEmulatorServices, $androidEmulatorServices, $androidEmulatorDiscovery, $emulatorHelper, $prompter) {
        super();
        this.$logger = $logger;
        this.$errors = $errors;
    ...
    isAppInstalledOnDevices(deviceIdentifiers, appId, projectName) {
    ...
    startDeviceDetectionIntervals(deviceInitOpts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deviceDetectionInterval = setInterval(() => __awaiter(this, void 0, void 0, function* () {
            ...
            const emulatorDetectionInterval = setInterval(() => __awaiter(this, void 0, void 0, function* () {
    ...
    startLookingForDevices(deviceInitOpts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.detectCurrentlyAttachedDevices(deviceInitOpts);
            yield this.detectCurrentlyAvailableEmulators();
            yield this.startDeviceDetectionIntervals(deviceInitOpts);
        });
    }
    ...
    deployOnDevices(deviceIdentifiers, packagePath, appId, projectName) {
