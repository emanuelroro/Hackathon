...
class AndroidPluginBuildService {
    constructor($injector, $fs, $childProcess, $hostInfo, $androidToolsInfo, $logger, $packageManager, $projectDataService, $devicePlatformsConstants, $errors, $filesHashService) {
    ...
    buildAar(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (shouldBuildAar) {
                ...
                yield this.buildPlugin({ pluginDir: pluginTempDir, pluginName: options.pluginName });
    ...
    getRuntimeGradleVersions(projectDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (projectDir) {
                const projectRuntimeVersion = this.$platformService.getCurrentPlatformVersion(this.$devicePlatformsConstants.Android, this.$projectDataService.getProjectData(projectDir));
