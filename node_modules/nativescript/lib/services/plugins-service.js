...
class PluginsService {
    constructor($packageManager, $fs, $options, $logger, $errors, $filesHashService, $injector) {
    ...
    add(plugin, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (realNpmPackageJson.nativescript) {
                ...
                try {
                    yield this.$pluginVariablesService.savePluginVariablesInProjectFile(pluginData, projectData.projectDir);
                }
                catch (err) {
                    ...
                    yield this.$packageManager.uninstall(plugin, PluginsService.NPM_CONFIG, projectData.projectDir);
                    throw err;
                }
