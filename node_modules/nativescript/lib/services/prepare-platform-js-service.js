...
class PreparePlatformJSService extends prepare_platform_service_1.PreparePlatformService {
    constructor($fs, $xmlValidator, $hooksService, $errors, $logger, $projectDataService, $nodeModulesBuilder, $packageManager) {
    ...
    getPathToPlatformTemplate(selectedTemplate, frameworkPackageName, projectDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (selectedTemplate) {
                ...
                try {
                    const npmInstallResult = yield this.$packageManager.install(selectedTemplate, tempDir, {
