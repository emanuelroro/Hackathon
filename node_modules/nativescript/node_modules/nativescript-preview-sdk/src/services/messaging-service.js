...
var MessagingService = /** @class */ (function () {
    ...
    MessagingService.prototype.handleSendInitialFiles = function (data, instanceId, retries, skipDeviceCheck, hmrMode) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var device, devicesChannel, deviceConnectedMessage, isAndroid, minimumSupportedVersion, showDeprecatedPage, payloads, payloads, initialPayload;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        payloads = this.appContentManager.getDeprecatedAppPayloads();
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        if (!this.config.showLoadingPage) return [3 /*break*/, 5];
                        payloads = this.appContentManager.getLoadingAppPayloads();
                        return [4 /*yield*/, this.showPage(devicesChannel, device, payloads, { hmrMode: hmrMode, publisher: data.publisher })];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5: return [4 /*yield*/, this.config.getInitialFiles(device)];
                    case 6:
                        initialPayload = _a.sent();
                        if (!(initialPayload && initialPayload.files && initialPayload.files.length)) return [3 /*break*/, 8];
