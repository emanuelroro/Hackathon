...
class XCodeSimctlSimulator extends iphone_simulator_name_getter_1.IPhoneSimulatorNameGetter {
    ...
    run(applicationPath, applicationIdentifier, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!options.skipInstall) {
                yield this.installApplication(device.id, applicationPath);
            }
    ...
    installApplication(deviceId, applicationPath) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.simctl.install(deviceId, applicationPath);
            }
            catch (err) {
                yield this.simctl.install(deviceId, applicationPath);
            }
    ...
    stopApplication(deviceId, appIdentifier, bundleExecutable) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.simctl.terminate(deviceId, appIdentifier);
            utils.sleep(0.5);
        });
    }
    ...
    startSimulator(options, device) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!device && options.device) {
                yield this.verifyDevice(options.device);
            }
            device = device || (yield this.getDeviceToRun(options));
            if (device && device.id) {
                yield this.verifyDevice(device);
            }
