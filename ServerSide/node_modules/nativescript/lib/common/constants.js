...
exports.RUNNING_EMULATOR_STATUS = "Running";
exports.NOT_RUNNING_EMULATOR_STATUS = "Not running";
...
exports.IOS_LOG_PREDICATE = 'senderImagePath contains "NativeScript" || eventMessage contains[c] "NativeScript"';
...
AndroidVirtualDevice.INI_FILES_MASK = /^(.*)\.ini$/i;
...
AndroidVirtualDevice.AVD_FILE_EXTENSION = ".avd";
AndroidVirtualDevice.RUNNING_AVD_EMULATOR_REGEX = /^(emulator-\d+)\s+device$/;
AndroidVirtualDevice.RUNNING_GENY_EMULATOR_REGEX = /^(.+?)\s+device$/;
AndroidVirtualDevice.GENYMOTION_VENDOR_NAME = "Genymotion";
AndroidVirtualDevice.AVD_VENDOR_NAME = "Avd";
