...
class ListDevicesCommand {
    ...
    execute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.$options.availableDevices) {
                ...
                if (!platform && args[0]) {
                    this.$errors.failWithoutHelp(`${args[0]} is not a valid device platform. The valid platforms are ${helpers_1.formatListOfNames(this.$mobileHelper.platformNames)}`);
                }
    ...
    printEmulators(title, emulators) {
        ...
        const table = helpers_1.createTable(["Device Name", "Platform", "Version", "Device Identifier", "Image Identifier", "Error Help"], []);
