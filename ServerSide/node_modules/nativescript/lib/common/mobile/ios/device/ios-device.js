...
class IOSDevice extends ios_device_base_1.IOSDeviceBase {
    constructor(deviceActionInfo, $errors, $injector, $iOSDebuggerPortService, $deviceLogProvider, $lockService, $iOSSocketRequestExecutor, $processService, $devicePlatformsConstants, $iOSDeviceProductNameMapper, $iosDeviceOperations, $mobileHelper) {
        super();
    ...
    getDebugSocketCore(appId, projectName) {
        const _super = name => super[name];
        return __awaiter(this, void 0, void 0, function* () {
            yield _super("attachToDebuggerFoundEvent").call(this, projectName);
