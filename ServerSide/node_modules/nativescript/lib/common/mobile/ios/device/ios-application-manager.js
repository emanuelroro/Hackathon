...
class IOSApplicationManager extends application_manager_base_1.ApplicationManagerBase {
    ...
    getInstalledApplications() {
        return __awaiter(this, void 0, void 0, function* () {
            const applicationsLiveSyncStatus = yield this.getApplicationsInformation();
    ...
    runApplicationCore(appData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.$iosDeviceOperations.start([{ deviceId: this.device.deviceInfo.identifier, appId: appData.appId, ddi: this.$options.ddi, waitForDebugger }]);
        });
    }
    startDeviceLog() {
        return __awaiter(this, void 0, void 0, function* () {
