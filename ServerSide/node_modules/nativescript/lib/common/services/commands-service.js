...
class CommandsService {
    constructor($analyticsSettingsService, $errors, $hooksService, $injector, $logger, $options, $staticConfig, $helpService, $extensibilityService, $optionsTracker) {
    ...
    printHelp(commandName, commandArguments) {
    ...
    executeCommandAction(commandName, commandArguments, action) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.$errors.beginCommand(() => action.apply(this, [commandName, commandArguments]), () => this.printHelp(commandName, commandArguments));
        });
    }
            ...
            if (canExecute) {
                ...
                if (command) {
                    if (!suppressCommandHelp) {
                        yield this.printHelp(commandName, commandArguments);
                    }
                }
            }
        });
