...
class CreatePluginCommand {
    ...
    setupSeed(projectDir, pluginRepoName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!helpers_1.isInteractive() && (!config.username || !config.pluginName)) {
            ...
            const outputScript = (yield this.$childProcess.spawnFromEvent(process.execPath, params, "close", { cwd, timeout: 10000 }));
