...
class PreviewAppFilesService {
    constructor($fs, $logger, $platformsData, $projectDataService, $projectFilesManager, $projectFilesProvider) {
        this.$fs = $fs;
        this.$logger = $logger;
    ...
    getRootFilesDir(data, platform) {
        ...
        if (data.bundle) {
            rootFilesDir = path.join(platformData.appDestinationDirectoryPath, constants_1.APP_FOLDER_NAME);
        }
        else {
