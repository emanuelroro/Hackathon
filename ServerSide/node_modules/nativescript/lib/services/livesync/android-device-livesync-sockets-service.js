...
class AndroidDeviceSocketsLiveSyncService extends android_device_livesync_service_base_1.AndroidDeviceLiveSyncServiceBase {
    constructor(data, $injector, $platformsData, $staticConfig, $logger, device, $options, $processService, $fs, $devicePlatformsConstants, $filesHashService) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.livesyncTool.hasConnection()) {
                try {
                    ...
                    yield this.device.applicationManager.startApplication({ appId: deviceAppData.appIdentifier, projectName: this.data.projectName, justLaunch: true, waitForDebugger: false });
    ...
    restartApplication(projectData, liveSyncInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.device.applicationManager.restartApplication({ appId: liveSyncInfo.deviceAppData.appIdentifier, projectName: projectData.projectName, waitForDebugger: liveSyncInfo.waitForDebugger });
