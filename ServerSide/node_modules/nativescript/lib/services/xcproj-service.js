...
class XcprojService {
    ...
    getXcodeprojPath(projectData, platformData) {
        return path.join(platformData.projectRoot, projectData.projectName + constants_1.IosProjectConstants.XcodeProjExtName);
    }
    verifyXcproj(opts) {
