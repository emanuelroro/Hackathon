...
class InitService {
    constructor($fs, $logger, $options, $injector, $staticConfig, $projectHelper, $prompter, $packageManager, $packageInstallationManager) {
        this.$fs = $fs;
        this.$logger = $logger;
    ...
    getVersionData(packageName) {
        return __awaiter(this, void 0, void 0, function* () {
            const latestVersion = yield this.$packageInstallationManager.getLatestCompatibleVersion(packageName);
            if (this.useDefaultValue) {
                return this.buildVersionData(latestVersion);
            }
            const allVersions = yield this.$packageManager.view(packageName, { "versions": true });
