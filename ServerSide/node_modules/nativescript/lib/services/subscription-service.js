    ...
    subscribeForNewsletter() {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.shouldAskForEmail()) {
                this.$logger.printMarkdown(constants_1.SubscribeForNewsletterMessages.ReviewPrivacyPolicyMsg);
                this.$logger.printMarkdown(constants_1.SubscribeForNewsletterMessages.AgreeToReceiveEmailMsg);
                const email = yield this.getEmail(constants_1.SubscribeForNewsletterMessages.PromptMsg);
