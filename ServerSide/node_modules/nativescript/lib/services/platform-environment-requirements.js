    ...
    processSyncToPreviewAppIfNeeded(selectedOption, projectDir, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (selectedOption === PlatformEnvironmentRequirements.SYNC_TO_PREVIEW_APP_OPTION_NAME) {
                ...
                yield this.$previewQrCodeService.printLiveSyncQrCode({ useHotModuleReload: options.hmr, link: options.link });
            }
        });
    }
...
__decorate([
    decorators_1.cache()
], PlatformEnvironmentRequirements.prototype, "$liveSyncService", null);
